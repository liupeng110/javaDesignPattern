...
public class TemplateMethodActivity_ViewBinding<T extends TemplateMethodActivity> implements Unbinder {
  protected T target;

  @UiThread
  public TemplateMethodActivity_ViewBinding(T target, View source) {
    this.target = target;
